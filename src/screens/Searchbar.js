  ...
  return (
    <View style={styles.container}>
      ...
      style={{
        ...
        fontFamily: 'Roboto',
        fontStyle: 'normal',
      }}onPress={()=> navigation.goBack()}>Cari Klinik terdekat</Text>
      </TouchableOpacity>
      </View>

      <View style={{flexDirection:'row'}}>
      <Icon1 style={{start:10, top:12}} name='location-pin' color={'#875C25'} size={27}/>
      <Text
      style={{
        color: '#000',
        fontSize: 20,
        ...
        <Icon style={{right:40, top:12}} name='pencil' color={'#A7A7A7'} size={27}/>
      </View>
